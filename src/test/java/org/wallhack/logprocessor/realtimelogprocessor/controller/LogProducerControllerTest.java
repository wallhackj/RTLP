    ...
    class LogProducerControllerTest {
        ...
        public void testSendLog() {
            ...
            when(kafkaTemplate.send(eq("realtimelog"), eq(logDTO))).thenReturn(CompletableFuture.completedFuture(null));
            ...
            verify(kafkaTemplate).send(eq("realtimelog"), captor.capture());
